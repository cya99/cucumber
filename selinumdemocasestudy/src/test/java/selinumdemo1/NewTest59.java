...
public class NewTest77 {
  ...
  public void beforeTest() {
	  htmlReporter=
			  new ExtentHtmlReporter(System.getProperty("user.dir")+"/extentreports/report1.html");
	  extent = new ExtentReports();
	  extent.attachReporter(htmlReporter);
  }
  @Test(priority=1)
  public void testRegistration() {
	  extent.createTest("testing the registration page");
	  Assert.assertTrue(true);
  }
  @Test(priority=2)
  public void logintest() {
	  extent.createTest("testing the login page");
	  Assert.assertTrue(true);
  }
  @Test(priority=3)
  public void addcat() {
	  extent.createTest("testing the add to cart page");
	  Assert.assertTrue(true);
  }
  @Test(priority=4)
  public void payment() {
	  extent.createTest("testing the payment page");
	  Assert.assertTrue(true);
...
ExtentTest logger;
 ...
 htmlReporter= new ExtentHtmlReporter(System.getProperty("user.dir")+"/extentreports/report1.html");
 extent=new ExtentReports();
 extent.attachReporter(htmlReporter);
  }
  @Test(priority=1)
